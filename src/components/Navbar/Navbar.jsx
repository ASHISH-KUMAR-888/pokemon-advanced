  ...
  return (
    <>
      <div className="bg-white h-[70px] w-screen flex justify-between items-center pl-[30px] pr-[20px] md:px-[30px]">
        <img
          className="h-full"
          src="images/Pokemon-Logo-Clipart-edit-online (1).png"
          alt="Logo"
        />
      ...
      <div className="mt-[20px] px-[20px] flex flex-col justify-between items-center md:px-[10%]">
        <img
          src="images/d70128f665c0687a491a0bef962b4e72~2.png"
          alt="Title Image"
        />
      ...
      <div className="flex justify-center items-center mb-[30px] gap-[30px] flex-wrap">
        <Link to="/favorites">
          <button className="bg-[orange] text-black font-black py-[10px] px-[20px] rounded cursor-pointer">
            Favorites Pokemon
          </button>
        </Link>
